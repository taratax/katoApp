...
class TransportViewController: UINavigationController {

    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.ś
        // Set the default and selected images to use template mode
                let originalImage = UIImage(named: "transport")?.withRenderingMode(.alwaysTemplate)
